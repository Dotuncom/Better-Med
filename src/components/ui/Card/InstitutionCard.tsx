...
const InstitutionCard = ({title,price,image}:InstitutionCardProps) => {
  return (
    <div className='relative border border-accent/50 group max-w-100 h-[290px] overflow-hidden rounded flex flex-col items-centerm justify-center gap-9 bg-cover bg-center bg-no-repeat transition-all delay-880 duration-900 ease-in-out' style={{backgroundImage:`url(${image})`}}>
